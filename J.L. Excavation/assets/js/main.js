/* JL Excavation — global interactions
   - Mobile menu
   - Scroll reveal (IntersectionObserver)
   - Stat counters (one-shot)
   - Hero parallax (desktop, > 960px)
   - FAQ accordion
   - Service area / project filtering
   - File upload visual feedback
   - Conditional bid-date field
...
(function () {
  ...
  if (heroBg && window.innerWidth > 960 && !reduced) {
    let ticking = false;
    function onScroll() {
      if (!ticking) {
